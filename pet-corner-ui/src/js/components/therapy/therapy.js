...
function Therapy() {
  ...
  function searchByAge() {
    ...
    let options = {
      headers: headers,
      type: "get",
      url: `http://localhost:8765/therapy/v2/animalsTherapy/filter/age/${min}/${max}`,
      dataType: null,
      cache: false,
      data: null,
      processData: false,
  ...
  function searchByDim() {
    ...
    let options = {
      headers: headers,
      type: "get",
      url: `http://localhost:8765/therapy/v2/animalsTherapy/filter/size/${min}/${max}`,
      dataType: null,
      cache: false,
      data: null,
      processData: false,
  ...
  function searchByPlace() {
    ...
    let options = {
      headers: headers,
      type: "get",
      url: `http://localhost:8765/therapy/v2/animalsTherapy/provenance/${place}`,
      dataType: null,
      cache: false,
      data: null,
      processData: false,
